...
- `.github/skills/github-issue-management/SKILL.md` — universal conventions
- `.github/instructions/github-issue-management.instructions.md` — repository-specific rules, templates, milestone names, and the mat-plan constraints